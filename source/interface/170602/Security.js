...
(function(module, require, exports)
{
    ...
    NetCore.AccompTask = Slice.defineStruct(
        function(taskid, taskname, username, department, startime, endtime, addrs)
        {
            this.taskid = taskid !== undefined ? taskid : "";
            this.taskname = taskname !== undefined ? taskname : "";
            this.username = username !== undefined ? username : "";
            this.department = department !== undefined ? department : "";
            this.startime = startime !== undefined ? startime : 0;
        ...
        function(__os)
        {
            ...
            __os.writeString(this.username);
            __os.writeString(this.department);
            __os.writeInt(this.startime);
            __os.writeInt(this.endtime);
        ...
        function(__is)
        {
            ...
            this.username = __is.readString();
            this.department = __is.readString();
            this.startime = __is.readInt();
            this.endtime = __is.readInt();
    ...
    NetCore.ImsiInfo = Slice.defineStruct(
        function(imsi, imei, captime, devname, county, province, city)
        {
            this.imsi = imsi !== undefined ? imsi : "";
            this.imei = imei !== undefined ? imei : "";
            this.captime = captime !== undefined ? captime : 0;
            this.devname = devname !== undefined ? devname : "";
    ...
    {
        "GetUsers": [, , , , , [3], [[7], [3], [3]], [[3], ["NetCore.UserInfoSeqHelper"]], , , ],
        ...
        "GetHeatMapData": [, , , , , [3], [[3], [3], [7]], [[7]], , , ],
        "GetMigrateData": [, , , , , [3], [[3], [3], [3], [7]], [["NetCore.MigrateDataSeqHelper"]], , , ],
        "GetActPath": [, , , , , [3], [[7], [7], [3], [3], [7]], [["NetCore.PosInfoSeqHelper"]], , , ],
        "GetAccompTarget": [, , , , , [3], [[7], [7], [7], [3], [3], ["NetCore.AddrAreaSeqHelper"]], [["NetCore.AccompTargetSeqHelper"]], , , ],
        "GetAccompTask": [, , , , , [3], [[7], [7]], [["NetCore.AccompTaskSeqHelper"]], , , ],
        "UpdateAccompTask": [, , , , , [3], [["NetCore.AccompTaskSeqHelper"], [NetCore.OBJOPTYPE.__helper]], , , , ],
        "GetSuspectTarget": [, , , , , [3], [[7], [7], [7], [3], [3]], [["NetCore.SuspectTargetSeqHelper"]], , , ],
        ...
        "IMSIQuery": [, , , , , [3], [[3], [7], [7], [3], [3]], [["NetCore.ImsiInfoSeqHelper"]], , , ]
    });
